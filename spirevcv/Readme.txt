...
The wSPIRE con-sists of 88 (54 males and 34 females) speakers recorded using fiverecording devices in neutral and whispered modes.
So this dataset contains almost 44000 audio recordings resulting in a total of approx 36hours of speech corpus. 
Apart from this, wSPIRE corpus also con-tains word-level annotations for each recording.
...
Female Speaker and recording details:
ID | Whisper Count | Neutral Count | Sentences
-----------------------------------------------
100| 250 | 250 | 1-50
103| 250 | 250 | 151-200
12 | 250 | 250 | 51-100
...
Male Speaker and recording details:
ID | Whisper Count | Neutral Count | Sentences
-----------------------------------------------
101| 250 | 250 | 51-100
102| 250 | 250 | 101-150
...
1. Zoom XYH-6 Adjustable Stereo Microphone Capsule - https://www.zoom.co.jp/products/product-accessories/xyh-6-xy-stereo-microphone-capsule
2. Philips Stereo Headphones SHP1900/97 - https://www.philips.co.in/c-p/SHP1900_97/stereo-headphones
3. Apple iPhone 7 - https://www.gsmarena.com/apple_iphone_7-8064.php
4. Nokia 5.1 - https://www.nokia.com/phones/en_int/nokia-5-1
5. Motorola moto e5 plus - https://www.motorola.in/smartphones-moto-e5-plus/p

Word Transcription:

An example of word-level annotaion provided in wSPIRE. 
...
We have chosen a sampling rate of 44.1kHz with 16-bits/sample for all recording devices, and later it was downsampled to 16kHz, having a bit-rate of 256kbps.
All the recordings were recorded in WAV format.

ID - Each speaker was given a unique id.
SET - We have nine different type of sets, numbered from 1 to 9.
...
Example: “ID06_006_F_Neutral_Headset_11.lab” (txt file)

Audio file name: “ID0[ID]_00[SET]_[GENDER]_[MODE]_[DEVICE]_[SENTNUM].wav”
Example: “ID06_006_F_Neutral_Headset_11.wav” (wav file)

Directory Structure:

---wSPIRE
	|
	---Gender_Mode_Device (It contains wav files and their correspnding word-level annotations according to gender of the speaker, mode of speech and recording device) 
		|
		---timestamp (It contains word-level annotations) 
		---wav (It contains the audio files in '.wav' format)
---EOD